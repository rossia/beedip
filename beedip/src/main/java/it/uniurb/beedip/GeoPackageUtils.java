...
import it.uniurb.beedip.filter.InputFilterDecimalMinMax;
    ...
    public static void showMessage(Activity activity, String title,
        ...
        if (title != null || message != null) {
            new AlertDialog.Builder(activity)
                    ...
                    .setNeutralButton(
                            activity.getString(it.uniurb.beedip.R.string.button_ok_label),
    ...
    public static void prepareTileLoadInputs(final Activity activity,
        ...
        if (setZooms) {
            minZoomInput.setText(String.valueOf(activity.getResources().getInteger(
                    it.uniurb.beedip.R.integer.load_tiles_default_min_zoom_default)));
            maxZoomInput.setText(String.valueOf(activity.getResources().getInteger(
                    it.uniurb.beedip.R.integer.load_tiles_default_max_zoom_default)));
        }
        ...
        compressQualityInput.setText(String.valueOf(activity.getResources()
                .getInteger(it.uniurb.beedip.R.integer.load_tiles_compress_quality_default)));
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    adapter.addAll(activity.getResources().getStringArray(
                            it.uniurb.beedip.R.array.preloaded_tile_url_labels));
                    AlertDialog.Builder builder = new AlertDialog.Builder(activity);
                    builder.setTitle(activity
                            .getString(it.uniurb.beedip.R.string.load_tiles_preloaded_label));
                                ...
                                public void onClick(DialogInterface dialog, int item) {
                                    if (item >= 0) {
                                        String[] urls = activity
                                                .getResources()
                                                .getStringArray(
                                                        it.uniurb.beedip.R.array.preloaded_tile_urls);
                                        String[] names = activity
                                                .getResources()
                                                .getStringArray(
                                                        it.uniurb.beedip.R.array.preloaded_tile_url_names);
                                        int[] minZooms = activity
                                                .getResources()
                                                .getIntArray(
                                                        it.uniurb.beedip.R.array.preloaded_tile_url_min_zoom);
                                        int[] maxZooms = activity
                                                .getResources()
                                                .getIntArray(
                                                        it.uniurb.beedip.R.array.preloaded_tile_url_max_zoom);
                                        int[] defaultMinZooms = activity
                                                .getResources()
                                                .getIntArray(
                                                        it.uniurb.beedip.R.array.preloaded_tile_url_default_min_zoom);
                                        int[] defaultMaxZooms = activity
                                                .getResources()
                                                .getIntArray(
                                                        it.uniurb.beedip.R.array.preloaded_tile_url_default_max_zoom);
                                        int[] epsgs = activity
                                                .getResources()
                                                .getIntArray(
                                                        it.uniurb.beedip.R.array.preloaded_tile_url_epsg);
                                        if (nameInput != null) {
        ...
        if(supportsMaxFeatures){
            if(featuresIndexed) {
                int maxFeatures = activity.getResources().getInteger(
                        it.uniurb.beedip.R.integer.feature_tiles_load_max_features_per_tile_default);
                if (maxFeatures >= 0) {
        ...
        preloadedButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(
                        activity, android.R.layout.select_dialog_item);
                adapter.addAll(activity.getResources().getStringArray(
                        it.uniurb.beedip.R.array.preloaded_bounding_box_labels));
                AlertDialog.Builder builder = new AlertDialog.Builder(activity);
                builder.setTitle(activity
                        .getString(it.uniurb.beedip.R.string.bounding_box_preloaded_label));
                builder.setAdapter(adapter,
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int item) {
                                if (item >= 0) {
                                    String[] locations = activity
                                            .getResources()
                                            .getStringArray(
                                                    it.uniurb.beedip.R.array.preloaded_bounding_box_locations);
